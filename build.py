    ...
    for palette_name, palette in colors.items():
        ...
        for style_name in palette['styles']:
            ...
            if style_config.get("generate_turned_variant", True):
                auto_sub_styles["turned"] = {"transpose": Transpose.ROTATE_90,
                                             "suffix": "-turned",
            ...
            for auto_sub_style in auto_sub_styles:
                ...
                style_description_name = style_config['description_name'] + auto_sub_style_config.get("description_name_suffix", "")
                style_explanation = style_config['explanation'] + auto_sub_style_config.get("explanation_suffix", "")
                ...
                pack_friendly_name = f"{palette['description_name']} Tooltip ({style_description_name})"
                ...
                try:
                    # Generate images
                    background_image = apply_template(style_config['background'], palette_colors, auto_sub_style_config.get("transpose", None))
                    frame_image = apply_template(style_config['frame'], palette_colors, auto_sub_style_config.get("transpose", None))
